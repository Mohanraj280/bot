...
os.environ["OPENAI_API_KEY"] = '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'

openai.api_key = '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'
...
if __name__ == "__main__":
    app.run(host="localhost", port=8081, debug=True) # Runs the ChatBot on port:8001 (you can use a different one)
